        ...
        >
          <div className="section-panel-hero max-content-width pt-12 pb-16 md:pt-16 md:pb-20 xl:grid xl:grid-cols-2 xl:items-center xl:gap-12">
            ...
            <div className="animate-fade-in-up">
              ...
              {/* サブテキスト */}
              <p className="text-[17px] text-[#6B7280] mb-8 break-keep mobile:text-[12px]" style={KEEP_ALL_STYLE}>
                医師・看護師による
          ...
          <div className="max-content-width">
            <div className="section-panel">
              ...
              <div className="max-w-2xl mx-auto">
                <PricingTable items={sharedPricingItems} variant="hero" />
              </div>
              <div className="mt-6">
                <InlineIconLink href="/service" icon="payments" className="text-link-inline" iconClassName="text-[20px]">
                  料金プランを詳しく見る
                </InlineIconLink>
              </div>
            </div>
        ...
        <section className="page-section bg-white" aria-labelledby="faq-heading">
          <div className="max-content-width">
            <div className="section-panel">
              ...
              <StaticFaqList items={homeFaqItems} variant="hero" />
              <div className="mt-6">
                <InlineIconLink href="/faq" icon="quiz" className="text-link-inline" iconClassName="text-[20px]">
                  よくある質問をもっと見る
                </InlineIconLink>
              </div>
            </div>
            ...
            <div className="section-panel">
              <div className="mx-auto flex max-w-3xl flex-col gap-8 xl:flex-row xl:items-center xl:gap-12">
                <div className="flex-1 space-y-4 text-center xl:text-left">
                  ...
                  <p className="copy-body text-[#334155] break-keep md:text-[17px]" style={KEEP_ALL_STYLE}>
                    千葉県佐倉市を中心に以下の地域へ
                    <br className="md:hidden" />
                    お伺いしております。
                  </p>
                  ...
                  <div className="flex items-center justify-center gap-2 pt-4 text-[#334155] xl:justify-start">
                    ...
                    <p className="copy-body-lg text-left break-keep xl:whitespace-nowrap" style={KEEP_ALL_STYLE}>
                      上記以外のエリア（近隣市区町村）も
                      <br className="md:hidden" />
                      お気軽にご相談ください。
                    </p>
        ...
        <section className="page-section bg-[#0369A1]" id="facility" aria-labelledby="contact-heading">
          <div className="max-content-width">
            <div className="section-panel">
              ...
              <p className="text-[16px] text-white/90 mb-8 break-keep" style={KEEP_ALL_STYLE}>
                ご不明点・ご相談はお気軽にどうぞ。
                <br className="md:hidden" />
                無料でご相談いただけます。
              </p>
